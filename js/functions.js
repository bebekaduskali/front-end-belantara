        ...
        pageLoader: function () {
            ...
            if (!$body.hasClass('no-page-loader')) {
                var pageInAnimation = $body.attr('data-animation-in') || "fadeIn",
                    ...
                    pageLoaderIcon = $body.attr('data-icon') || 21,
                    pageLoaderIconColor = '#fff',
                ...
                $('#wrapper').animsition({
                    ...
                    loadingInner: '<div class="">' + loadingInnerHTML + '</div>',
